                ...
                {todayBirthdays.map((student) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSentToday ? (
                        <div className="bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 font-extrabold text-xs px-3 py-2 rounded-xl flex items-center gap-1.5 shrink-0 shadow-sm">
